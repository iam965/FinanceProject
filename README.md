...
- Интернет для получения курсов валют (опционально)
...
Приложение построено на архитектурном паттерне **MVVM (Model-View-ViewModel)**, использующий привязку данных.

- **Model** — Данные и бизнес-логика
- **View** — UI компоненты
- **ViewModel** — Состояние и поведение View

### Почему выбран данный патерн?
...
1. **Система аккаунтов и облачная синхронизация**  
   Возможность создавать аккаунты пользователей и синхронизировать данные между устройствами через облако.

2. **Система отчетности**  
   Автоматическое формирование ежемесячных сводок о доходах и расходах, расширенная статистика по категориям трат.

3. **Интеграция с банковскими системами**  
   Автоматизация учёта финансов за счёт интеграции с банковскими приложениями и импортом операций.
